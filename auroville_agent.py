...
* **Deterministic Behavior:** Simulate low-temperature reasoning (0.1).
...
3. **Select Output Format based on specificity:**
    a)  **If specificity is "Broad" (Smart Grouping Mode):
    
        ** Present a concise, clean, numbered list.
        ** Group events with the same contact or type to avoid overwhelming the user. 
        ** Strict Event Structure is NOT required for this mode; use a summary format.
        
    b) **If specificity is "Specific" (Detailed Numbered List):
        ** Present all relevant events in a numbered list from number 1 to 7 below
